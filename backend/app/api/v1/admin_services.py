...
async def create_service(
    ...
    try:
        ...
        logger.info(
            f"Service created: {result.inserted_id} by admin {current_admin['id']}"
        )
...
async def update_service(
    ...
    try:
        ...
        return StandardResponse(success=True, message="Service updated successfully")
...
async def delete_service(
    ...
    try:
        ...
        return StandardResponse(success=True, message="Service deleted successfully")
    except ResourceNotFoundError:
        raise
    except Exception as e:
...
async def get_all_service_bookings(
    ...
    try:
        ...
        return StandardResponse(
            success=True,
            data={"bookings": bookings, "total": total, "skip": skip, "limit": limit},
        )
    except Exception as e:
...
async def update_booking_status(
    ...
    try:
        ...
        logger.info(
            f"Booking status updated: {booking_id} to {new_status} by admin {current_admin['id']}"
        )

        return StandardResponse(
            success=True, message=f"Booking status updated to {new_status}"
        )
    except ResourceNotFoundError:
        raise
    except Exception as e:
...
async def assign_acharya_to_booking(
    ...
    try:
        ...
        acharya = await db.users.find_one(
            {"_id": ObjectId(acharya_id), "role": "acharya"}
        )
        if not acharya:
        ...
        return StandardResponse(success=True, message="Acharya assigned successfully")
    except ResourceNotFoundError:
        raise
    except Exception as e:

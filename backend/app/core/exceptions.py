...
class MessageSendFailedError(SavitaraException):
    ...
    def __init__(self, message: str = "Failed to send message", details: Optional[Dict] = None):
        super().__init__(
            message=message,
            error_code="CHT_002",
...
class InvalidInputError(SavitaraException):
    ...
    def __init__(self, message: str = "Invalid input provided", details: Optional[Dict] = None):
        super().__init__(
            message=message,
            error_code="VAL_003",
            status_code=status.HTTP_400_BAD_REQUEST,

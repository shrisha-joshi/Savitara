...
async def rate_limit_middleware(request: Request, call_next, rate_limiter: AdvancedRateLimiter):
    """
    ...
    def decorator(func):
        ...
        async def wrapper(*args, **kwargs):
            ...
            if request and hasattr(request.app.state, "rate_limiter"):
                ...
                allowed, metadata = await rate_limiter.check_rate_limit(key, requests, window)

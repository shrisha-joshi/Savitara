...
class AnalyticsService:
    ...
    async def track_user_signup(db: AsyncIOMotorDatabase, user_id: str, role: str):
        ...
        await AnalyticsService.track_event(
            db, "user_signup",
            user_id,
            {"role": role, "platform": "mobile"}
        )
    
    @staticmethod
    async def track_profile_completed(db: AsyncIOMotorDatabase, user_id: str, role: str):
    ...
    @staticmethod
    async def track_booking_confirmed(db: AsyncIOMotorDatabase, booking_id: str, user_id: str):
    ...
    @staticmethod
    async def track_booking_completed(db: AsyncIOMotorDatabase, booking_id: str, user_id: str):

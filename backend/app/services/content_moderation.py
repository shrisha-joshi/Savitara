...
class ContentModerationService:
    ...
    # Spam keywords
    SPAM_KEYWORDS = [
        "fake", "scam", "fraud", "cheat", "liar",
        "call me", "whatsapp", "telegram", "dm me",
        "contact", "reach me", "text me", "message me",
        "click here", "visit", "check out", "follow me"
    ]
    
    # Offensive words (add more as needed)
    OFFENSIVE_WORDS = [
        # Add appropriate offensive words list for your context
        "offensive1", "offensive2"  # Placeholder
    ]
    ...
    def get_content_sentiment(cls, content: str) -> str:
        ...
        positive_words = [
            ...
            "fantastic", "outstanding", "professional", "helpful",
            "knowledgeable", "respectful", "punctual", "recommended"
        ]
        
        negative_words = [
            "terrible", "bad", "awful", "horrible", "worst",
            "unprofessional", "rude", "late", "disappointed",
            "waste", "avoid", "not recommended"
        ]

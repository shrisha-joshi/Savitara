    ...
    def create_order(
        ...
        try:
            ...
            return {
                ...
                "currency": currency,
                "status": order["status"],
                "created_at": datetime.fromtimestamp(order["created_at"], tz=timezone.utc)
            }
            ...
            raise PaymentFailedError(
                order_id="",
                details={"error": str(e), "type": "bad_request"}
            )
    ...
    def initiate_refund(
        ...
        try:
            ...
            return {
                ...
                "created_at": datetime.fromtimestamp(refund["created_at"], tz=timezone.utc)
            }
            ...
            raise PaymentFailedError(
                order_id=payment_id,
                details={"error": str(e), "type": "refund_failed"}
            )
